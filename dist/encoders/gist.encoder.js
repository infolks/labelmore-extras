...
class GistEncoder extends labelmore_devkit_1.Encoder {
    constructor() {
        super();
        this.title = "GIST";
    ...
    encode(frame, project) {
        ...
        // return write info
        return [{
                name: `${helpers_1.removeExtension(frame.name)}.txt`,
    ...
    encodeLabel(label, frameName) {
        if (label.type == labelmore_devkit_1.DEFAULT_LABEL_TYPES.boundbox) {
            ...
            return [helpers_1.removeExtension(frameName), label.class_id, ...labelProps].join(',');
        }
        return null;
    }
}
...
//# sourceMappingURL=gist.encoder.js.map